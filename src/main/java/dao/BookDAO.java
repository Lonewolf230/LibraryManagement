...
public boolean addBook(Book book) throws SQLException {
    ...
    public void deleteBook(String isbn) throws SQLException {
        String checkSql = "SELECT COUNT(*) FROM books WHERE isbn=? AND is_deleted= 0";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement checkStmt = conn.prepareStatement(checkSql)) {
        ...
        String sql = "UPDATE books SET is_deleted=1 WHERE isbn= ?";
        try (Connection conn = DatabaseConnection.getConnection();
             PreparedStatement pstmt = conn.prepareStatement(sql)) {
    ...
    public List<Book> getAvailableBooks() throws SQLException {
        ...
        String sql = "SELECT * FROM books WHERE is_available = 1 AND (is_deleted = 0 OR is_deleted IS NULL) ORDER BY title";
    ...
    public List<Book> getAllBooks() throws SQLException {
        List<Book> books = new ArrayList<>();
        String sql = "SELECT * FROM books WHERE is_deleted = 0 OR is_deleted IS NULL";
    ...
    public boolean checkIsbnExists(String isbn) throws SQLException {
        String sql = "SELECT 1 FROM books WHERE isbn = ? AND (is_deleted = 0 OR is_deleted IS NULL)";
